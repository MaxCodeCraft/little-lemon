    ...
    <>
      {props.lunchOrDinner === "lunch" && (
        <div className="relative w-80">
          ...
          <select
            className={`${useSelector((state) => state.formerrors.time) && "border-e-4 border-s-4 border-red-500"} block w-full appearance-none rounded-lg bg-highlightLight py-4 text-center text-xl font-bold text-primaryGreen shadow-lg focus:outline-none`}
            defaultValue=""
